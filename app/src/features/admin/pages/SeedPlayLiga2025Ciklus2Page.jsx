...
const GROUPS = [
  {
    ...
    matches: [
      // ── Round 1 ──────────────────────────────────────────────────────
      { p1:0, p2:1, winnerIdx:0, scheduledAt:null,               scores:[{player1:7,player2:5},{player1:6,player2:1}] },                              // A  def MC 7-5 6-1
      { p1:2, p2:3, winnerIdx:2, scheduledAt:'2025-07-14T18:00', scores:[{player1:7,player2:6},{player1:5,player2:7},{player1:10,player2:3}] },        // VS def MM 7-6 5-7 10-3 (ST)
      // IS bye | PB vs MO not played
      // ── Round 2 ──────────────────────────────────────────────────────
      { p1:0, p2:2, winnerIdx:0, scheduledAt:null,               scores:[{player1:6,player2:0},{player1:6,player2:2}] },                              // A  def VS 6-0 6-2
      { p1:5, p2:3, winnerIdx:3, scheduledAt:'2025-07-04T18:30', scores:[{player1:5,player2:7},{player1:4,player2:6}] },                              // MM def PB 7-5 6-4
      // MC bye | IS vs MO not played
      // ── Round 3 ──────────────────────────────────────────────────────
      { p1:0, p2:4, winnerIdx:0, scheduledAt:null,               scores:[{player1:6,player2:1},{player1:6,player2:2}] },                              // A  def IS 6-1 6-2
      { p1:1, p2:2, winnerIdx:2, scheduledAt:null,               scores:[{player1:6,player2:0},{player1:3,player2:6},{player1:4,player2:10}] },        // VS def MC 0-6 6-3 10-4 (ST)
      // PB bye | MM vs MO not played
      // ── Round 4 ──────────────────────────────────────────────────────
      { p1:0, p2:5, winnerIdx:0, scheduledAt:'2025-07-09T18:00', scores:[{player1:6,player2:2},{player1:6,player2:4}] },                              // A  def PB 6-2 6-4
      // MC vs IS, VS vs MO not played | MM bye
      // ── Round 5 ──────────────────────────────────────────────────────
      { p1:0, p2:3, winnerIdx:0, scheduledAt:null,               scores:[{player1:6,player2:0},{player1:6,player2:3}] },                              // A  def MM 6-0 6-3
      { p1:1, p2:5, winnerIdx:1, scheduledAt:'2025-07-21T19:00', scores:[{player1:7,player2:5},{player1:6,player2:1}] },                              // MC def PB 7-5 6-1
      { p1:2, p2:4, winnerIdx:2, scheduledAt:'2025-08-14T18:00', scores:[{player1:6,player2:2},{player1:6,player2:0}] },                              // VS def IS 6-2 6-0
      // MO bye
      // ── Round 6 ──────────────────────────────────────────────────────
      { p1:1, p2:3, winnerIdx:1, scheduledAt:null,               scores:[{player1:6,player2:1},{player1:6,player2:2}] },                              // MC def MM 6-1 6-2
      { p1:4, p2:5, winnerIdx:4, scheduledAt:null,               scores:[{player1:6,player2:4},{player1:6,player2:3}] },                              // IS def PB 6-4 6-3
      // A vs MO not played | VS bye
      // ── Round 7 ──────────────────────────────────────────────────────
      { p1:2, p2:5, winnerIdx:2, scheduledAt:'2025-08-14T18:00', scores:[{player1:7,player2:5},{player1:2,player2:6},{player1:10,player2:5}] },        // VS def PB 7-5 2-6 10-5 (ST)
      { p1:4, p2:3, winnerIdx:4, scheduledAt:null,               scores:[{player1:6,player2:4},{player1:7,player2:6}] },                              // IS def MM 6-4 7-6
  ...
  },
  {
    ...
    matches: [
      // ── Round 1 ──────────────────────────────────────────────────────
      { p1:0, p2:1, winnerIdx:0, scheduledAt:null,                scores:[{player1:6,player2:2},{player1:6,player2:4}] },                              // JM def IB 6-2 6-4
      { p1:2, p2:3, winnerIdx:3, scheduledAt:'2025-08-19T20:30',  scores:[{player1:5,player2:7},{player1:6,player2:7}] },                              // IO def BC 7-5 7-6
      { p1:4, p2:5, winnerIdx:4, scheduledAt:null,                scores:[{player1:6,player2:1},{player1:6,player2:2}] },                              // DS def MS 6-1 6-2
      // LS vs G not played
      // ── Round 2 ──────────────────────────────────────────────────────
      { p1:0, p2:2, winnerIdx:0, scheduledAt:null,                scores:[{player1:6,player2:3},{player1:6,player2:0}] },                              // JM def BC 6-3 6-0
      { p1:1, p2:5, winnerIdx:1, scheduledAt:null,                scores:[{player1:7,player2:6},{player1:6,player2:2}] },                              // IB def MS 7-6 6-2
      // DS vs G, LS vs IO not played
      // ── Round 3 ──────────────────────────────────────────────────────
      { p1:1, p2:2, winnerIdx:1, scheduledAt:null,                scores:[{player1:6,player2:4},{player1:4,player2:6},{player1:10,player2:2}] },        // IB def BC 6-4 4-6 10-2 (ST)
      { p1:3, p2:7, winnerIdx:3, scheduledAt:null,                scores:[{player1:6,player2:3},{player1:6,player2:3}] },                              // IO def G  6-3 6-3
      // JM vs DS, LS vs MS not played
      // ── Round 4 ──────────────────────────────────────────────────────
      { p1:1, p2:4, winnerIdx:1, scheduledAt:null,                scores:[{player1:6,player2:3},{player1:7,player2:5}] },                              // IB def DS 6-3 7-5
      { p1:2, p2:7, winnerIdx:7, scheduledAt:'2025-07-10T18:00',  scores:[{player1:6,player2:4},{player1:4,player2:6},{player1:7,player2:10}] },        // G  def BC 4-6 6-4 10-7 (ST)
      { p1:3, p2:5, winnerIdx:3, scheduledAt:'2025-07-03T18:00',  scores:[{player1:6,player2:3},{player1:6,player2:4}] },                              // IO def MS 6-3 6-4
      // JM vs LS not played
      // ── Round 5 ──────────────────────────────────────────────────────
      { p1:0, p2:3, winnerIdx:0, scheduledAt:null,                scores:[{player1:6,player2:1},{player1:6,player2:4}] },                              // JM def IO 6-1 6-4
      // IB vs LS, BC vs DS, G vs MS not played
      // ── Round 6 ──────────────────────────────────────────────────────
      { p1:1, p2:3, winnerIdx:1, scheduledAt:null,                scores:[{player1:6,player2:4},{player1:2,player2:6},{player1:10,player2:7}] },        // IB def IO 6-4 2-6 10-7 (ST)
      // JM vs G, BC vs MS, DS vs LS not played
      // ── Round 7 ──────────────────────────────────────────────────────
      { p1:0, p2:5, winnerIdx:0, scheduledAt:null,                scores:[{player1:6,player2:2},{player1:6,player2:0}] },                              // JM def MS 6-2 6-0
      { p1:4, p2:3, winnerIdx:3, scheduledAt:null,                scores:[{player1:4,player2:6},{player1:4,player2:6}] },                              // IO def DS 6-4 6-4
  ...
  },
  {
    ...
    matches: [
      // ── Round 4 ──────────────────────────────────────────────────────
      { p1:0, p2:5, winnerIdx:0, scheduledAt:null, scores:[{player1:6,player2:4},{player1:6,player2:4}] }, // N  def BM 6-4 6-4
      // ── Round 5 ──────────────────────────────────────────────────────
      { p1:2, p2:4, winnerIdx:4, scheduledAt:null, scores:[{player1:4,player2:6},{player1:6,player2:7}] }, // SM def N3 6-4 7-6
        ...
        <div className="mt-8 max-w-lg space-y-4">
          <Card>
            ...
            <ul className="space-y-1 text-sm text-text-light">
              ...
              <li className="text-amber-600">• Novi igrači: D. Stamenovic (DS), M. Djelosevic (MD)</li>
            </ul>
