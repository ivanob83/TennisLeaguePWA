...
const GROUPS = [
  {
    ...
    matches: [
      ...
      }, // IS def M  6-2 6-2
      {
        ...
        p2: 7,
        winnerIdx: 7,
        scheduledAt: '2025-09-20T10:00',
        scores: [
          { player1: 4, player2: 6 },
          { player1: 4, player2: 3 },
        ],
      }, // IB def MM (IB won set 1 6-4; set 2 retired/walkover)
      // A vs VS not played
      // ── Round 2 ──────────────────────────────────────────────────────
      {
        p1: 0,
      ...
      }, // A  def MC 6-2 6-4
      {
        ...
        p2: 3,
        winnerIdx: 6,
        scheduledAt: '2025-09-25T16:00',
        scores: [
          { player1: 3, player2: 6 },
          { player1: 6, player2: 4 },
          { player1: 10, player2: 6 },
        ],
      }, // MM def IO 3-6 6-4 10-6 (ST)
      ...
      }, // MC def VS 6-4 6-1
      {
        ...
        p2: 5,
        winnerIdx: 5,
        scheduledAt: '2025-09-04T17:00',
        scores: [
          { player1: 3, player2: 6 },
          { player1: 6, player2: 3 },
          { player1: 9, player2: 11 },
        ],
      }, // M  def MM 6-3 3-6 11-9 (ST)
      {
        p1: 3,
        p2: 7,
        winnerIdx: 3,
        scheduledAt: '2025-09-16T17:00',
        scores: [
          { player1: 6, player2: 3 },
          { player1: 6, player2: 3 },
        ],
  ...
  },
  {
    ...
    matches: [
      ...
      }, // BC def SM 3-6 6-4 10-8 (ST)
      {
        p1: 6,
        p2: 5,
        winnerIdx: 5,
        scheduledAt: '2025-09-16',
        scores: [
          { player1: 6, player2: 7 },
          { player1: 6, player2: 7 },
        ],
      ...
      }, // JM def SM 6-4 6-1
      {
        ...
        scores: [
          { player1: 6, player2: 3 },
          { player1: 6, player2: 7 },
          { player1: 1, player2: 10 },
        ],
      }, // BC def DS 6-3 6-7 10-1 (ST)
