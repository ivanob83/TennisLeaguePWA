...
export default function PlayerConnectionRequestsPage() {
  ...
  async function handleApprove(request) {
    ...
    try {
      ...
      showToast({ title: 'Approved', message: `${request.playerName} linked to ${request.userName}.`, variant: 'success' })
    } catch {
  ...
  async function handleReject(request) {
    ...
    try {
      ...
      showToast({ title: 'Rejected', message: `Request from ${request.userName} rejected.`, variant: 'info' })
    } catch {
  ...
  async function handleDirectLink(e) {
    ...
    try {
      ...
      setDirectUserId('')
      setDirectUserEmail('')
      showToast({ title: 'Linked', message: `${player.name} has been linked to the user.`, variant: 'success' })
    } catch {
        ...
        {resolved.length > 0 && (
          <section>
            ...
            <div className="space-y-2">
              {resolved.map(r => (
                <div key={r.id} className="flex items-center justify-between border border-gray-200 px-4 py-3">
                  <div className="min-w-0">
