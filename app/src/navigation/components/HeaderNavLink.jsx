      ...
      className={cn(
        ...
        mobile
          ? [
              ...
              active
                ? 'text-secondary'
                : 'bg-white text-text hover:text-secondary',
            ]
          : [
      ...
      {mobile ? (
        <>
          <span className="flex items-center gap-3">
            <span className={cn('flex items-center justify-center', active ? 'text-secondary' : 'text-primary group-hover:text-secondary')}>
